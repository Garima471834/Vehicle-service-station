...
<style>
 body{
background-image: url(/VehicleServiceStation/images/pic36.avif);
...
<a href="/VehicleServiceStation/client/view_services.jsp?pid=<%=p.getProvider_id() %>">view services</a>
</div>
</div>
</div>
<%} %>
