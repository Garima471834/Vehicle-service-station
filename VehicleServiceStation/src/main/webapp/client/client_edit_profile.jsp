...
<style>
 body{
background-image: url(/VehicleServiceStation/images/card.avif);
  ...
  <div class="container py-5 h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-lg-6 mb-4 mb-lg-0">
        <div class="card mb-3" style="border-radius: .5rem;background-color: #D5F5E3">
          <div class="row g-0">
            <div class="col-md-4 gradient-custom text-center "
              style="border-top-left-radius: .5rem; border-bottom-left-radius: .5rem;">
              <img src="/VehicleServiceStation/images/pic17.jpg"
                alt="Avatar" class="img-fluid my-5" style="width: 80px;" />
                <input type="text" name="name" class="form-control" value="<%=c.getClient_name() %>"> 
              ...
              <div class="card-body p-4">
                ...
                <div class="row pt-1">
                  <div class="col-6 mb-3">
                    ...
                    <input type="text" name="email" class="form-control" value="<%=c.getEmail_ID() %>"> </p>
                  </div>
                  <div class="col-6 mb-3">
                    <h6>Phone</h6>
                    <p class="text-muted">
                    
                    <input type="text" name="phone" class="form-control" value="<%=c.getContact_number() %>"> </p>
                  </div>
                  <div class="col-6 mb-3">
                    <h6>City</h6>
                    <p class="text-muted">
                    ...
                    <input type="text" name="city" class="form-control" value="<%=c.getCity() %>"> </p>
                  </div>
                  <div class="col-6 mb-3">
                    <h6>Address</h6>
                    <p class="text-muted">
                    <textarea type="text" name="address" class="form-control" rows="4"cols="10"><%=c.getAddress() %>"></textarea> </p>
                  </div>
